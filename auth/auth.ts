 ...
 */
export class UserAgentAuthentication implements SecurityAuthentication {
    /**
...
export type AuthMethods = {
    ...
    "userAgent"?: SecurityAuthentication
}
...
export function configureAuthMethods(config: AuthMethodsConfiguration | undefined): AuthMethods {
    ...
    if (config["userAgent"]) {
        authMethods["userAgent"] = new UserAgentAuthentication(
            config["userAgent"]
        );
    }
